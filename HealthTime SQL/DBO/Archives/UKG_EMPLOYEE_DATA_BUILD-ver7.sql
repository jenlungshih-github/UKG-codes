...
/****** Object:  StoredProcedure [dbo].[UKG_EMPLOYEE_DATA_BUILD]    Script Date: 9/6/2025 7:03:48 AM ******/
SET ANSI_NULLS ON
GO
...
FROM STAGE.UKG_EMPL_E_T	  EMPL
    ...
    SELECT distinct
        ...
        ISNULL(CAST(UKG_ES.EFFDT AS VARCHAR), '')  AS 'Custom Field 4',   -- 9/3/2025  Replace EMPL.EFFDT with UKG_ES.EFFDT  
        --CASE WHEN NON_UKG_MANAGER_FLAG = 'T' THEN '' ELSE empl.EMPL_STATUS END AS 'Custom Field 5',
        ISNULL(EMPL.HR_STATUS, '') AS 'Custom Field 5',
        ''  AS 'Custom Field 6',
