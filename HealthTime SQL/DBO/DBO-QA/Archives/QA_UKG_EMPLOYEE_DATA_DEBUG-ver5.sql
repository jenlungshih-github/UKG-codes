...
/****** Object:  StoredProcedure [stage].[QA_SP_UKG_EMPLOYEE_DATA_DEBUG]    Script Date: 2/3/2026 12:48:17 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [stage].[QA_SP_UKG_EMPLOYEE_DATA_DEBUG]
    @EMPLID VARCHAR(11) = '10861356'
AS
/***************************************
* Created By: Jim Shih	
* Purpose: QA stored procedure to debug why specific employees are filtered out from UKG_EMPLOYEE_DATA
* Usage: EXEC [stage].[QA_SP_UKG_EMPLOYEE_DATA_DEBUG] '10861356'
...
BEGIN
    ...
    FROM health_ods.[health_ods].[RPT].CURRENT_EMPL_DATA EMPL
        LEFT OUTER JOIN health_ods.[stage].[CURRENT_POSITION_PRI_FIN_UNIT_ALL_LOOKUP_V] FIN
