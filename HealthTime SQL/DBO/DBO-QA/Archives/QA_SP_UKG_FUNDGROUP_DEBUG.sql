...
/****** Object:  StoredProcedure [stage].[QA_UKG_FUNDGROUP_DEBUG]    Script Date: 9/6/2025 9:43:52 AM ******/
SET ANSI_NULLS ON
GO
...
Create or ALTER PROCEDURE [stage].[QA_SP_UKG_FUNDGROUP_DEBUG]
    @EMPLID VARCHAR(11) = '10420386'
AS
/***************************************
* Created By: Jim Shih	
* Purpose: QA stored procedure to debug UKG_BS.FundGroup value for specific employee
* Usage: EXEC [stage].[QA_SP_UKG_FUNDGROUP_DEBUG] '10420386'
