...
/****** Object:  View [stage].[UKG_tsr_differncds_V]    Script Date: 2/3/2026 3:09:46 PM ******/
SET ANSI_NULLS ON
GO
...
FROM (
	...
	FROM health_ods.hcm_ods.PS_UC_SHFT_ONC_ERN e
	INNER JOIN (
		SELECT setid
			,jobcode
			,erncd
			,max(effdt) effdt
		FROM health_ods.hcm_ods.PS_UC_SHFT_ONC_ERN s
