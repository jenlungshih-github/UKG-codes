...
/****** Object:  StoredProcedure [stage].[SP_UKG_GET_INACTIVE_EMPLID_BY_PAYPERIOD]    Script Date: 9/6/2025 10:16:17 PM ******/
SET ANSI_NULLS ON
GO
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/
CREATE OR ALTER           PROCEDURE [stage].[SP_UKG_GET_INACTIVE_EMPLID_BY_PAYPERIOD]
--    @paybeginddt DATE,
    @payenddt DATE
AS
BEGIN
