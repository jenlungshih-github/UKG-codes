...
/****** Object:  StoredProcedure [stage].[SP_UKG_EMPL_STATUS_LOOKUP_BUILD_RETRO_ONLY]    Script Date: 9/5/2025 5:51:04 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [stage].[SP_UKG_EMPL_STATUS_LOOKUP_BUILD_RETRO_ONLY]
AS
BEGIN
    ...
    MERGE [stage].[UKG_EMPL_STATUS_LOOKUP] AS TARGET
    USING (
        SELECT --top 1000
        UnionData.emplid,
