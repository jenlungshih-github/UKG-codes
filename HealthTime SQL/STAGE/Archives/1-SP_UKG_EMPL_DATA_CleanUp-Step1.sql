...
/****** Object:  StoredProcedure [stage].[SP_UKG_EMPL_DATA_CleanUp-Step1]    Script Date: 9/15/2025 4:30:18 PM ******/
SET ANSI_NULLS ON
GO
...
/***************************************
* Stored Procedure: [stage].[SP_UKG_EMPL_DATA_CleanUp-Step1]
...
ALTER       PROCEDURE [stage].[SP_UKG_EMPL_DATA_CleanUp-Step1]
AS
BEGIN
    SET NOCOUNT ON;
