...
BEGIN
    ...
    BEGIN
        ...
        SELECT
            'Level UP Temp Debug' as DebugStep,
            Inactive_EMPLID,
            POSITION_REPORTS_TO,
            PS_JOB_EMPLID
        FROM [stage].[UKG_PositionReportsAnalysis_Level_UP_TEMP]
    ...
    BEGIN
        ...
        SELECT DISTINCT
            ...
            temp2.[Inactive_EMPLID] as Inactive_EMPLID,
            temp2.[POSITION_REPORTS_TO] as Inactive_EMPLID_POSITION_NBR,
            empl2.MANAGER_EMPLID,
            empl2.MANAGER_NAME,
            empl2.POSITION_REPORTS_TO,
            empl2.emplid as empl2_emplid,
            empl2.NAME as empl2_name
        FROM [stage].[UKG_PositionReportsAnalysis_Level_UP_TEMP] temp2
            LEFT JOIN health_ods.health_ods.[RPT].[CURRENT_EMPL_DATA] empl2
            ON empl2.POSITION_NBR = temp2.[POSITION_REPORTS_TO]
        WHERE temp2.[POSITION_REPORTS_TO] = '40689748'
            AND temp2.[PS_JOB_EMPLID] IS NOT NULL;
    END
