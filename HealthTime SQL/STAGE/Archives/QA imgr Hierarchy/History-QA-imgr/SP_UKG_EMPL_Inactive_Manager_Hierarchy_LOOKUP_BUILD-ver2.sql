...
/****** Object:  StoredProcedure [stage].[SP_UKG_EMPL_Inactive_Manager_Hierarchy_LOOKUP_BUILD]    Script Date: 9/1/2025 7:40:00 AM ******/
SET ANSI_NULLS ON
GO
...
Create or ALTER   PROCEDURE [stage].[SP_UKG_EMPL_Inactive_Manager_Hierarchy_LOOKUP_BUILD]
AS
-- exec [stage].[SP_UKG_EMPL_Inactive_Manager_Hierarchy_LOOKUP_BUILD]
/***************************************
* Created By: Jim Shih	
...
BEGIN
    ...
    INSERT INTO [stage].[UKG_EMPL_Inactive_Manager_Hierarchy]
        ...
        MANAGER_POSN_LEVEL, To_Trace_Up_2, NOTE_L1, HIERARCHY_LEVEL, CREATED_DT
        )
    SELECT
        POSITION_NBR_To_Check,
        MANAGER_POSITION_NBR,
    ...
    INSERT INTO [stage].[UKG_EMPL_Inactive_Manager_Hierarchy]
        ...
        POSITION_NBR_To_Check, MANAGER_POSITION_NBR, POSN_LEVEL, To_Trace_Up_1,
        MANAGER_POSITION_NBR_L1, MANAGER_EMPLID, MANAGER_HR_STATUS, MANAGER_POSN_STATUS,
        MANAGER_POSN_LEVEL, To_Trace_Up_2, NOTE_L1,
