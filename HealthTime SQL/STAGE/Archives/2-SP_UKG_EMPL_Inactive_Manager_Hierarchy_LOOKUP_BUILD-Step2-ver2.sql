...
/****** Object:  StoredProcedure [stage].[SP_UKG_EMPL_Inactive_Manager_Hierarchy_LOOKUP_BUILD-Step2]    Script Date: 9/18/2025 7:22:03 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    WITH
        ...
        (
            ...
            FROM [dbo].[UKG_EMPLOYEE_DATA]                            -- Check only from [dbo].[UKG_EMPLOYEE_DATA] 
            WHERE 
