...
/****** Object:  StoredProcedure [stage].[SP_UKG_EMPL_DATA_TEMP_CleanUp-Step1]    Script Date: 12/2/2025 11:41:50 AM ******/
SET ANSI_NULLS ON
GO
...
/***************************************
* Stored Procedure: [stage].[SP_UKG_EMPL_DATA_TEMP_CleanUp-Step1]
* Purpose: Clean up duplicate employee records in UKG_EMPLOYEE_DATA_TEMP table
* 
* Logic:
...
ALTER         PROCEDURE [stage].[SP_UKG_EMPL_DATA_TEMP_CleanUp-Step1]
AS
BEGIN
    SET NOCOUNT ON;
