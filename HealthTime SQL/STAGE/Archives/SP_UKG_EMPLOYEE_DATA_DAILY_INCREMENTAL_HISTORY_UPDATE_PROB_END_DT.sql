...
-- Version: 1.1
-- Updated: 2026-01-28 Jim Shih - Only update rows where NOTE does not already contain the probation retention message
-- ==========================================================================================
CREATE PROCEDURE SP_UKG_EMPLOYEE_DATA_DAILY_INCREMENTAL_HISTORY_UPDATE_PROB_END_DT
AS
BEGIN
    SET NOCOUNT ON;
