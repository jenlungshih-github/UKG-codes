...
/****** Object:  StoredProcedure [dbo].[UKG_LABOR_CATEGORY_ENTRY_LIST_and_PROFILE_BUILD]    Script Date: 9/3/2025 1:50:00 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[UKG_LABOR_CATEGORY_ENTRY_LIST_and_PROFILE_BUILD]
AS  
...
BEGIN
    ...
    SET @SQL_DROP = NULL; -- Reset the variable for the second drop operation
